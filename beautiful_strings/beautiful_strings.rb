# When John was a little kid he didn't have much to do. There was no internet, no Facebook, and no programs to hack on. So he did the only thing he could... 
...
File.open(filename, "r").each_line do |line|
	...
	beauty = line.chomp.downcase.gsub(/[^a-z\s]/, ' ').chars.select.each_with_object([]) { |beauty, l| }
	.map do |beauty|

	 (1..26).inject(1) { |sum, beauty| sum + beauty }
